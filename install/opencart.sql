...
CREATE TABLE IF NOT EXISTS `oc_tvcmsblogcategory_main` (
        ...
        PRIMARY KEY (`tvcmsblogcategory_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
DROP TABLE IF EXISTS `oc_tvcmsblogcategory_sub`;
CREATE TABLE IF NOT EXISTS `oc_tvcmsblogcategory_sub` (
        ...
        PRIMARY KEY (`tvcmsblogcategory_sub_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
DROP TABLE IF EXISTS `oc_tvcmsblog_main`;
CREATE TABLE IF NOT EXISTS `oc_tvcmsblog_main` (
        ...
        PRIMARY KEY (`tvcmsblog_main_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
DROP TABLE IF EXISTS `oc_tvcmsblog_sub`;
CREATE TABLE IF NOT EXISTS `oc_tvcmsblog_sub` (
      ...
      PRIMARY KEY (`tvcmsblog_sub_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
DROP TABLE IF EXISTS `oc_tvcmsblog_gallery`;
CREATE TABLE IF NOT EXISTS `oc_tvcmsblog_gallery` ( 
      `tvcmsblog_gallery_id` int(11) AUTO_INCREMENT,
      `tvcmsblog_id` INT NOT NULL,
      `image` VARCHAR(255),
    PRIMARY KEY (`tvcmsblog_gallery_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
DROP TABLE IF EXISTS `oc_tvcmsblog_comment`;
CREATE TABLE IF NOT EXISTS `oc_tvcmsblog_comment` (
    ...
    `tvcmsblog_comment_status` INT NOT NULL ,
        PRIMARY KEY (`tvcmsblog_comment_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

CREATE TABLE IF NOT EXISTS `oc_tvcmsnewsletter` (
    `tvcmsnewsletter_id` int(11) AUTO_INCREMENT,
    `tvcmsnewsletter_email` VARCHAR(255),
    `tvcmsnewsletter_adddate` datetime,
     PRIMARY KEY (`tvcmsnewsletter_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_tvcmsimageslidermain` ( 
  ...
  PRIMARY KEY (`tvcmsimageslidermain_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
CREATE TABLE `oc_tvcmsimageslidersub` (
  ...
  PRIMARY KEY (`tvcmsimageslidersub_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

  INSERT INTO `oc_tvcmsimageslidermain` SET      
    tvcmsimageslidermain_pos    = 1; 
         
  INSERT INTO `oc_tvcmsimageslidersub` SET 
    tvcmsimageslidermain_id           = 1,
    tvcmsimageslidersub_link          = '#',
    tvcmsimageslidersub_des_main      = 'Best Selling Products This Week',
    tvcmsimageslidersub_des_sub       = 'Best Selling Products This Week',
    tvcmsimageslidersub_image         = 'catalog/themevolty/slider/demo_img_1.jpg',
    tvcmsimageslidersub_title         = 'Rising from the Deep',
    tvcmsimageslidersub_textaligment  = 'ttvmain-slider-contant-left',
    tvcmsimageslidersub_buttoncaption = 'read more',
    tvcmsimageslidersub_enable        = 1,
    tvcmsimageslidersublang_id        = 1;
   INSERT INTO `oc_tvcmsimageslidersub` SET 
    tvcmsimageslidermain_id           = 1,
    tvcmsimageslidersub_link          = '#',
    tvcmsimageslidersub_des_main      = 'Best Selling Products This Week',
    ...
    tvcmsimageslidersub_buttoncaption = 'read more',
    tvcmsimageslidersub_enable        = 1,
    tvcmsimageslidersublang_id        = 2;

  INSERT INTO `oc_tvcmsimageslidermain` SET      
    tvcmsimageslidermain_pos    = 2; 
         
  INSERT INTO `oc_tvcmsimageslidersub` SET 
    tvcmsimageslidermain_id           = 2,
    tvcmsimageslidersub_link          = '#',
    tvcmsimageslidersub_des_main      = 'Now & Wow Up To 80% Off',
    tvcmsimageslidersub_des_sub       = 'Now & Wow Up To 80% Off',
    tvcmsimageslidersub_image         = 'catalog/themevolty/slider/demo_img_2.jpg',
    tvcmsimageslidersub_title         = 'Solitary Catch Awaits',
    tvcmsimageslidersub_textaligment  = 'ttvmain-slider-contant-right',
    tvcmsimageslidersub_buttoncaption = 'read more',
    tvcmsimageslidersub_enable        = 1,
    tvcmsimageslidersublang_id        = 1;
  INSERT INTO `oc_tvcmsimageslidersub` SET 
...
PRIMARY KEY (`tvcmspaymenticonmain_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
PRIMARY KEY (`tvcmspaymenticonsub_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
INSERT INTO `oc_tvcmspaymenticonmain` SET  
  tvcmspaymenticonmain_id     = 1,
  tvcmspaymenticonmain_link   = '#',
  tvcmspaymenticonmain_image  = 'catalog/themevolty/paymenticon/demo_img_1.png',
  tvcmspaymenticonmain_pos    = 1,
  tvcmspaymenticon_status     = 1;
INSERT INTO `oc_tvcmspaymenticonsub` SET 
  tvcmspaymenticonmain_id     = 1,
  tvcmspaymenticonsub_title   = 'Application',
  tvcmspaymenticonsublang_id  = 1;
INSERT INTO `oc_tvcmspaymenticonsub` SET 
  tvcmspaymenticonmain_id     = 1,
  tvcmspaymenticonsub_title   = 'Application',
  tvcmspaymenticonsublang_id  = 2;   
INSERT INTO `oc_tvcmspaymenticonmain` SET  
  tvcmspaymenticonmain_id     = 2,
  tvcmspaymenticonmain_link   = '#',
  tvcmspaymenticonmain_image  = 'catalog/themevolty/paymenticon/demo_img_2.png',
  tvcmspaymenticonmain_pos    = 2,
  tvcmspaymenticon_status     = 1;
INSERT INTO `oc_tvcmspaymenticonsub` SET 
  tvcmspaymenticonmain_id     = 2,
  tvcmspaymenticonsub_title   = 'Application',
...
INSERT INTO `oc_tvcmspaymenticonsub` SET 
  ...
  tvcmspaymenticonsublang_id  = 2;
INSERT INTO `oc_tvcmspaymenticonmain` SET  
  tvcmspaymenticonmain_id     = 3,
  tvcmspaymenticonmain_link   = '#',
  tvcmspaymenticonmain_image  = 'catalog/themevolty/paymenticon/demo_img_3.png',
  tvcmspaymenticonmain_pos    = 3,
  tvcmspaymenticon_status     = 1;
INSERT INTO `oc_tvcmspaymenticonsub` SET 
  tvcmspaymenticonmain_id     = 3,
  tvcmspaymenticonsub_title   = 'Application',
...
INSERT INTO `oc_tvcmspaymenticonsub` SET 
  ...
  tvcmspaymenticonsublang_id  = 2;
INSERT INTO `oc_tvcmspaymenticonmain` SET  
  tvcmspaymenticonmain_id     = 4,
  tvcmspaymenticonmain_link   = '#',
  tvcmspaymenticonmain_image  = 'catalog/themevolty/paymenticon/demo_img_4.png',
  tvcmspaymenticonmain_pos    = 4,
  tvcmspaymenticon_status     = 1;
INSERT INTO `oc_tvcmspaymenticonsub` SET 
  tvcmspaymenticonmain_id     = 4,
  tvcmspaymenticonsub_title   = 'Application',
...
CREATE TABLE `oc_tvcmssocialiconmain` (
  ...
  PRIMARY KEY (`tvcmssocialiconmain_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
CREATE TABLE `oc_tvcmssocialiconsub` (
  ...
  PRIMARY KEY (`tvcmssocialiconsub_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
INSERT INTO `oc_tvcmssocialiconmain` SET
  tvcmssocialiconmain_link        = '#',
  tvcmssocialiconmain_class_name  = 'youtube',
  tvcmssocialiconmain_pos         = 1,
  tvcmssocialicon_status          = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 1,
  tvcmssocialiconsub_title        = 'Youtube',
  tvcmssocialiconsublang_id       = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 1,
  tvcmssocialiconsub_title        = 'Youtube',
  tvcmssocialiconsublang_id       = 2;
INSERT INTO `oc_tvcmssocialiconmain` SET
  tvcmssocialiconmain_link        = '#',
  tvcmssocialiconmain_class_name  = 'facebook',
  tvcmssocialiconmain_pos         = 2,
  tvcmssocialicon_status          = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 2,
  tvcmssocialiconsub_title        = 'Facebook',
  tvcmssocialiconsublang_id       = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 2,
  tvcmssocialiconsub_title        = 'Facebook',
...
INSERT INTO `oc_tvcmssocialiconmain` SET
  tvcmssocialiconmain_link        = '#',
  tvcmssocialiconmain_class_name  = 'twitter',
  tvcmssocialiconmain_pos         = 3,
  tvcmssocialicon_status          = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 3,
  tvcmssocialiconsub_title        = 'Twitter',
  tvcmssocialiconsublang_id       = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 3,
  tvcmssocialiconsub_title        = 'Twitter',
...
INSERT INTO `oc_tvcmssocialiconmain` SET
  tvcmssocialiconmain_link        = '#',
  tvcmssocialiconmain_class_name  = 'pinterest',
  tvcmssocialiconmain_pos         = 4,
  tvcmssocialicon_status          = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 4,
  tvcmssocialiconsub_title        = 'Pinterest',
  tvcmssocialiconsublang_id       = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 4,
  tvcmssocialiconsub_title        = 'Pinterest',
...
INSERT INTO `oc_tvcmssocialiconmain` SET
  tvcmssocialiconmain_link        = '#',
  tvcmssocialiconmain_class_name  = 'googleplus',
  tvcmssocialiconmain_pos         = 5,
  tvcmssocialicon_status          = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 5,
  tvcmssocialiconsub_title        = 'Google Plus',
  tvcmssocialiconsublang_id       = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 5,
  tvcmssocialiconsub_title        = 'Google Plus',
...
INSERT INTO `oc_tvcmssocialiconmain` SET
  tvcmssocialiconmain_link        = '#',
  tvcmssocialiconmain_class_name  = 'instagram',
  tvcmssocialiconmain_pos         = 6,
  tvcmssocialicon_status          = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 6,
  tvcmssocialiconsub_title        = 'Instagram',
  tvcmssocialiconsublang_id       = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 6,
  tvcmssocialiconsub_title        = 'Instagram',
...
INSERT INTO `oc_tvcmssocialiconmain` SET
  tvcmssocialiconmain_link        = '#',
  tvcmssocialiconmain_class_name  = 'vimeo',
  tvcmssocialiconmain_pos         = 7,
  tvcmssocialicon_status          = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 7,
  tvcmssocialiconsub_title        = 'Vimeo',
  tvcmssocialiconsublang_id       = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 7,
  tvcmssocialiconsub_title        = 'Vimeo',
...
INSERT INTO `oc_tvcmssocialiconmain` SET
  tvcmssocialiconmain_link        = '#',
  tvcmssocialiconmain_class_name  = 'rss',
  tvcmssocialiconmain_pos         = 8,
  tvcmssocialicon_status          = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 8,
  tvcmssocialiconsub_title        = 'rss',
  tvcmssocialiconsublang_id       = 1;
INSERT INTO `oc_tvcmssocialiconsub` SET 
  tvcmssocialiconmain_id          = 8,
  tvcmssocialiconsub_title        = 'rss',
...
CREATE TABLE `oc_tvcmstestimonialmain` (  
  ...
  PRIMARY KEY (`tvcmstestimonialmain_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
CREATE TABLE `oc_tvcmstestimonialsub` (
  ...
  PRIMARY KEY (`tvcmstestimonialsub_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
INSERT INTO `oc_tvcmstestimonialmain` SET
  tvcmstestimonialmain_link    = '#' ,
  tvcmstestimonial_img         = 'catalog/themevolty/testimonial/demo_img_1.png',
  tvcmstestimonial_sing_img    = 'catalog/themevolty/testimonial/demo_sign_img_1.png',
  tvcmstestimonial_sing_text   = 'Sing text' ,
  tvcmstestimonialmain_pos     = 1,
  tvcmstestimonial_status      = 1;
INSERT INTO `oc_tvcmstestimonialsub` SET 
  tvcmstestimonialmain_id                 = 1,
  tvcmstestimonialsub_title               = 'Darrel Austin',
  tvcmstestimonialsub_designation         = 'Themevolty',
  tvcmstestimonialsub_short_description   = 'Hello World',
...
INSERT INTO `oc_tvcmstestimonialsub` SET 
  ...
  tvcmstestimonialsub_short_description   = 'Hello World',
  tvcmstestimonialsub_description         = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmodtempor incididunt ut labore',
  tvcmstestimonialsublang_id              = 2;
INSERT INTO `oc_tvcmstestimonialmain` SET
  tvcmstestimonialmain_link               = '#' ,
  tvcmstestimonial_img                    = 'catalog/themevolty/testimonial/demo_img_2.png',
  tvcmstestimonial_sing_img               = 'catalog/themevolty/testimonial/demo_sign_img_2.png',
  tvcmstestimonial_sing_text              = 'Sing text' ,
  tvcmstestimonialmain_pos                = 2,
  tvcmstestimonial_status                 = 1;
INSERT INTO `oc_tvcmstestimonialsub` SET 
  tvcmstestimonialmain_id                 = 2,
  tvcmstestimonialsub_title               = 'Darrel Austin',
  tvcmstestimonialsub_designation         = 'Themevolty',
  tvcmstestimonialsub_short_description   = 'Hello World',
  tvcmstestimonialsub_description         = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmodtempor incididunt ut labore',
...
INSERT INTO `oc_tvcmstestimonialmain` SET
  tvcmstestimonialmain_link               = '#' ,
  tvcmstestimonial_img                    = 'catalog/themevolty/testimonial/demo_img_3.png',
  tvcmstestimonial_sing_img               = 'catalog/themevolty/testimonial/demo_sign_img_3.png',
  tvcmstestimonial_sing_text              = 'Sing text' ,
  tvcmstestimonialmain_pos                = 3,
  tvcmstestimonial_status                 = 1;
INSERT INTO `oc_tvcmstestimonialsub` SET 
  tvcmstestimonialmain_id                 = 3,
  tvcmstestimonialsub_title               = 'Darrel Austin',
  tvcmstestimonialsub_designation         = 'Themevolty',
  tvcmstestimonialsub_short_description   = 'Hello World',
  tvcmstestimonialsub_description         = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmodtempor incididunt ut labore',
...
CREATE TABLE `oc_tvcmsbrandlist` (
  `tvcmsbrandlist_id` INT NOT NULL AUTO_INCREMENT ,
   ...
   `tvcmsbrandlist_lang` text NOT NULL ,
    PRIMARY KEY (`tvcmsbrandlist_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
CREATE TABLE `oc_tvcustomlink` (  
  ...
  PRIMARY KEY (`tvcustomlink_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
CREATE TABLE `oc_tvcmstags` (
  ...
  PRIMARY KEY (`tvcmstags_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(1, 1, 'rio', 'Austin', '', 'rio', '', 'rio', 'rio', 222, 3516, '');
...
(25, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 0, 1, 1, 3, 0, '2009-01-31 01:04:25', '2011-05-30 12:14:55'),
(27, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 20, 0, 0, 2, 0, '2009-01-31 01:55:34', '2010-08-22 06:32:15'),
(20, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 0, 1, 1, 1, 1, '2009-01-05 21:49:43', '2011-07-16 02:14:42'),
(24, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 0, 1, 1, 5, 1, '2009-01-20 02:36:26', '2011-05-30 12:15:18'),
(18, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 0, 1, 0, 2, 1, '2009-01-05 21:49:15', '2011-05-30 12:13:55'),
(17, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 0, 1, 1, 4, 1, '2009-01-03 21:08:57', '2011-05-30 12:15:11'),
(28, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 25, 0, 0, 1, 0, '2009-02-02 13:11:12', '2010-08-22 06:32:46'),
(26, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 20, 0, 0, 1, 1, '2009-01-31 01:55:14', '2010-08-22 06:31:45'),
(29, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 25, 0, 0, 1, 1, '2009-02-02 13:11:37', '2010-08-22 06:32:39'),
(30, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 25, 0, 0, 1, 1, '2009-02-02 13:11:59', '2010-08-22 06:33:00'),
(31, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 25, 0, 0, 1, 1, '2009-02-03 14:17:24', '2010-08-22 06:33:06'),
(32, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 25, 0, 0, 1, 1, '2009-02-03 14:17:34', '2010-08-22 06:33:12'),
(33, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 0, 1, 1, 6, 1, '2009-02-03 14:17:55', '2011-05-30 12:15:25'),
(34, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 0, 1, 4, 7, 1, '2009-02-03 14:18:11', '2011-05-30 12:15:31'),
(35, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 28, 0, 0, 0, 1, '2010-09-17 10:06:48', '2010-09-18 14:02:42'),
(36, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 28, 0, 0, 0, 1, '2010-09-17 10:07:13', '2010-09-18 14:02:55'),
(37, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-09-18 14:03:39', '2011-04-22 01:55:08'),
(38, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-09-18 14:03:51', '2010-09-18 14:03:51'),
(39, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-09-18 14:04:17', '2011-04-22 01:55:20'),
(40, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-09-18 14:05:36', '2010-09-18 14:05:36'),
(41, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-09-18 14:05:49', '2011-04-22 01:55:30'),
(42, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-09-18 14:06:34', '2010-11-07 20:31:04'),
(43, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-09-18 14:06:49', '2011-04-22 01:55:40'),
(44, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-09-21 15:39:21', '2010-11-07 20:30:55'),
(45, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 18, 0, 0, 0, 1, '2010-09-24 18:29:16', '2011-04-26 08:52:11'),
(46, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 18, 0, 0, 0, 1, '2010-09-24 18:29:31', '2011-04-26 08:52:23'),
(47, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-11-07 11:13:16', '2010-11-07 11:13:16'),
(48, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-11-07 11:13:33', '2010-11-07 11:13:33'),
(49, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-11-07 11:14:04', '2010-11-07 11:14:04'),
(50, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-11-07 11:14:23', '2011-04-22 01:16:01'),
(51, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-11-07 11:14:38', '2011-04-22 01:16:13'),
(52, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-11-07 11:16:09', '2011-04-22 01:54:57'),
(53, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-11-07 11:28:53', '2011-04-22 01:14:36'),
(54, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-11-07 11:29:16', '2011-04-22 01:16:50'),
(55, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-11-08 10:31:32', '2010-11-08 10:31:32'),
(56, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 34, 0, 0, 0, 1, '2010-11-08 10:31:50', '2011-04-22 01:16:37'),
(57, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 0, 1, 1, 3, 1, '2011-04-26 08:53:16', '2011-05-30 12:15:05'),
(58, 'catalog/themevolty/categorybanner/Category-Banner.jpg', 52, 0, 0, 0, 1, '2011-05-08 13:44:16', '2011-05-08 13:44:16');
...
(28, 1, 'Architecture', '', 'Architecture', '', ''),
(33, 1, 'Ceramics', '', 'Ceramics', '', ''),
(32, 1, 'Conceptual', '', 'Conceptual', '', ''),
(31, 1, 'Drawing', '', 'Drawing', '', ''),
(30, 1, 'Painting', '', 'Painting', '', ''),
(29, 1, 'Photography', '', 'Photography', '', ''),
(27, 1, 'Ceramics', '', 'Ceramics', '', ''),
(26, 1, 'Art Brut', '', 'Art Brut', '', ''),
(17, 1, 'Calligraphy', '', 'Calligraphy', '', ''),
(25, 1, 'Ceramics', '', 'Ceramics', '', ''),
(24, 1, 'Collage', '', 'Collage', '', ''),
(20, 1, 'Drawing', '&lt;p&gt;\r\n Example of category description text&lt;/p&gt;\r\n', 'Drawing', 'Example of category description', ''),
(35, 1, 'test 1', '', 'test 1', '', ''),
(36, 1, 'test 2', '', 'test 2', '', ''),
(37, 1, 'test 5', '', 'test 5', '', ''),
(38, 1, 'test 4', '', 'test 4', '', ''),
...
(45, 1, 'Junk Art', '', 'Junk Art', '', ''),
(46, 1, 'Land Art', '', 'Land Art', '', ''),
...
(57, 1, 'Painting', '', 'Painting', '', ''),
(58, 1, 'test 25', '', 'test 25', '', ''),
(28, 2, 'Architecture', '', 'Architecture', '', ''),
(33, 2, 'Ceramics', '', 'Ceramics', '', ''),
(32, 2, 'Conceptual', '', 'Conceptual', '', ''),
(31, 2, 'Drawing', '', 'Drawing', '', ''),
(30, 2, 'Painting', '', 'Painting', '', ''),
(29, 2, 'Photography', '', 'Photography', '', ''),
(27, 2, 'Ceramics', '', 'Ceramics', '', ''),
(26, 2, 'Art Brut', '', 'Art Brut', '', ''),
(17, 2, 'Calligraphy', '', 'Calligraphy', '', ''),
(25, 2, 'Ceramics', '', 'Ceramics', '', ''),
(24, 2, 'Collage', '', 'Collage', '', ''),
(20, 2, 'Drawing', '&lt;p&gt;\r\n  Example of category description text&lt;/p&gt;\r\n', 'Drawing', 'Example of category description', ''),
(35, 2, 'test 1', '', 'test 1', '', ''),
(36, 2, 'test 2', '', 'test 2', '', ''),
(37, 2, 'test 5', '', 'test 5', '', ''),
...
(45, 2, 'Junk Art', '', 'Junk Art', '', ''),
(46, 2, 'Land Art', '', 'Land Art', '', ''),
...
(1, 1, 0, 1, 'rio', 'Austin', 'demo@rio.com', '1234567890', '', '48f8211a89c166639937aeeeddc689cd43691b45', 'CTWjPrbzZ', NULL, NULL, 0, 1, '', '127.0.0.1', 1, 0, '', '', '2018-03-19 15:04:56');
...
(74,'module','tvcmsspecialproduct'),
(73,'module','tvcmssocialicon'),
(72,'module','tvcmssingleblock'),
(85,'module','tvcmspaymenticon'),
(70,'module','tvcmsnewsletter'),
(69,'module','tvcmsnewsletterpopup'),
(68,'module','tvcmsmultibanner'),
(67,'module','tvcmsimageslider'),
(66,'module','tvcmsfooterlogo'),
(65,'module','tvcmscustomerservices'),
(64,'module','tvcmscustomsetting'),
(63,'module','tvcmsbrandlist'),
(62,'module','tvcmsblog'),
(61,'module','tvcmsblogcategory'),
(75,'module','tvcmsstoretime'),
(79,'module','tvcmstabproducts'),
(77,'module','tvcmstestimonial'),
(78,'module','tvcmstags'),
(80,'module','tvcmscustomlink'),
(83,'module','latest'),
(86,'module','tvcmsleftproduct'),
(87,'module','tvcmslefttestimonial');
...
(96,6,'account','column_left',0),
(131,1,'latest.71','content_top',7),
(132,1,'tvcmsspecialproduct.64','content_top',8),
(139,3,'tvcmsleftproduct.72','column_left',1),
(134,1,'tvcmsnewsletterpopup.59','content_top',10),
(133,1,'tvcmsbrandlist.52','content_top',9),
(129,1,'bestseller.70','content_top',5),
(127,1,'tvcmstwoofferbanner.67','content_top',3),
(130,1,'featured.28','content_top',6),
(128,1,'tvcmsblog.51','content_top',4),
(126,1,'tvcmstabproducts.65','content_top',2),
(140,3,'tvcmslefttestimonial.58','column_left',2),
(138,3,'category','column_left',0),
(100,7,'information','column_left',1),
(99,7,'category','column_left',0),
(97,6,'information','column_left',1),
(98,6,'account','column_right',1),
(101,12,'account','column_left',0),
(102,8,'account','column_left',0),
(144,11,'information','column_left',2),
(143,11,'account','column_left',1),
(142,11,'banner.30','column_left',0),
(146,5,'information','column_left',1),
(145,5,'category','column_left',0),
(109,13,'category','column_left',0),
(110,13,'information','column_left',1),
(111,9,'account','column_left',0),
(112,9,'information','column_left',1),
(125,1,'tvcmscustomerservices.53','content_top',1),
(124,1,'tvcmsimageslider.68','content_top',0);
...
(28,'Home Page','featured','{"name":"Home Page","product_name":"","product":["43","40","42","30"],"limit":"4","width":"250","height":"333","status":"1"}'),
(27,'Home Page','slideshow','{"name":"Home Page","banner_id":"7","width":"1140","height":"380","status":"1"}'),
(31,'Banner 1','banner','{"name":"Banner 1","banner_id":"6","width":"182","height":"182","status":"1"}'),
(72,'Left Right Product','tvcmsleftproduct','{"name":"Left Right Product","status":"1","status_left_feature":"0","left_feature_title":"Feature Products","status_left_new":"1","left_new_title":"New Products","status_left_best":"0","left_best_title":"Best Products","status_left_special":"1","left_special_title":"Special Products","status_right_feature":"0","right_feature_title":"Feature Products","status_right_new":"1","right_new_title":"New Products","status_right_best":"0","right_best_title":"Best Products","status_right_special":"1","right_special_title":"Special Products"}'),

(58,'Left Testimonial','tvcmslefttestimonial','{"name":"Left Testimonial","status":"1","title":{"2":"Our Testimonial","1":"Our Testimonial"}}'),
(59,'News Letter Popup','tvcmsnewsletterpopup','{"name":"News Letter Popup","status":1,"tvcmsnewsletterpopup":{"img_status":1,"bgimg_status":0,"lang_text":{"2":{"title":"Subscribe To Our Newsletter","subtitle":"Subscribe to our email newsletter today to receive update on the latest news","img":"catalog\/themevolty\/newsletter\/demo_img.jpg","bgimg":"catalog\/themevolty\/newsletter\/featured_offer_img_1.jpg"},"1":{"title":"Subscribe To Our Newsletter","subtitle":"Subscribe to our email newsletter today to receive update on the latest news","img":"catalog\/themevolty\/newsletter\/demo_img.jpg","bgimg":"catalog\/themevolty\/newsletter\/featured_offer_img_1.jpg"}}}}'),
(60,'News Letter','tvcmsnewsletter','{"name":"News Letter","status":1}'),
(70,'home','bestseller','{"name":"home","limit":"5","width":"250","height":"333","status":"1"}'),
(71,'home','latest','{"name":"home","limit":"5","width":"250","height":"333","status":"1"}'),
(73,'Left Right Blog Post','tvcmsleftblogpost','{"name":"Left Right Blog Post","status":"1"}'),
(68,'Image Slider','tvcmsimageslider','{"name":"Image Slider","status":1,"speed":5000,"hover":1,"loop":1,"slider":1}'),
(53,'Customer Services','tvcmscustomerservices','{"status":1,"name":"Customer Services","tvcmscustomerservices_main":{"2":{"tvcmscustomerservices_main_title":"Main Title","tvcmscustomerservices_main_short_des":"Short Description","tvcmscustomerservices_main_des":"Description","tvcmscustomerservices_main_img":"catalog\/themevolty\/customerservices\/demo_main_img.jpg"},"1":{"tvcmscustomerservices_main_title":"Main Title","tvcmscustomerservices_main_short_des":"Short Description","tvcmscustomerservices_main_des":"Description","tvcmscustomerservices_main_img":"catalog\/themevolty\/customerservices\/demo_main_img.jpg"}},"tvcmscustomerservices":{"2":{"tvcmscustomerservices_img_1":"catalog\/themevolty\/customerservices\/demo_img_1.png","lang_id":"2","tvcmscustomerservices_cap_1":"Free Shipping","tvcmscustomerservices_des_1":"Free Shipping On All Order","tvcmscustomerservices_status_1":"1","tvcmscustomerservices_img_2":"catalog\/themevolty\/customerservices\/demo_img_2.png","tvcmscustomerservices_cap_2":"Support 24\/7","tvcmscustomerservices_des_2":"We Support 24 Hours A Day","tvcmscustomerservices_status_2":"1","ttvcmscustomerservices_img_3":"catalog\/themevolty\/customerservices\/demo_img_3.png","tvcmscustomerservices_cap_3":"Gift Cards","tvcmscustomerservices_des_3":"Give Perfect Gift","tvcmscustomerservices_status_3":"1","tvcmscustomerservices_img_4":"catalog\/themevolty\/customerservices\/demo_img_4.png","tvcmscustomerservices_cap_4":"Payment 100% Secure","tvcmscustomerservices_des_4":"Payment 100% Secure","tvcmscustomerservices_status_4":"1","tvcmscustomerservices_img_5":"catalog\/themevolty\/customerservices\/demo_img_5.png","tvcmscustomerservices_cap_5":"Payment Method","tvcmscustomerservices_des_5":"Secure Payment","tvcmscustomerservices_status_5":"1"},"1":{"tvcmscustomerservices_img_1":"catalog\/themevolty\/customerservices\/demo_img_1.png","lang_id":"1","tvcmscustomerservices_cap_1":"Free Shipping","tvcmscustomerservices_des_1":"Free Shipping On All Order","tvcmscustomerservices_status_1":"1","tvcmscustomerservices_img_2":"catalog\/themevolty\/customerservices\/demo_img_2.png","tvcmscustomerservices_cap_2":"Support 24\/7","tvcmscustomerservices_des_2":"We Support 24 Hours A Day","tvcmscustomerservices_status_2":"1","ttvcmscustomerservices_img_3":"catalog\/themevolty\/customerservices\/demo_img_3.png","tvcmscustomerservices_cap_3":"Gift Cards","tvcmscustomerservices_des_3":"Give Perfect Gift","tvcmscustomerservices_status_3":"1","tvcmscustomerservices_img_4":"catalog\/themevolty\/customerservices\/demo_img_4.png","tvcmscustomerservices_cap_4":"Payment 100% Secure","tvcmscustomerservices_des_4":"Payment 100% Secure","tvcmscustomerservices_status_4":"1","tvcmscustomerservices_img_5":"catalog\/themevolty\/customerservices\/demo_img_5.png","tvcmscustomerservices_cap_5":"Payment Method","tvcmscustomerservices_des_5":"Secure Payment","tvcmscustomerservices_status_5":"1"}}}'),
(50,'Blog Category','tvcmsblogcategory','{"name":"Blog Category","status":1}'),
(51,'Blog Posts','tvcmsblog','{"name":"Blog Posts","status":1,"tvcmsblog_main":{"2":{"title":"LATEST NEWS","subtitle":"Mirum est notare quam littera gothica, quam nunc putamus parum claram anteposuerit litterarum formas.","des":"This is Description"},"1":{"title":"LATEST NEWS","subtitle":"Mirum est notare quam littera gothica, quam nunc putamus parum claram anteposuerit litterarum formas.","des":"This is Description"}}}'),
(52,'Brand List','tvcmsbrandlist','{"name":"Brand List","status":1,"tvcmsbrandlist_main":{"2":{"title":"test","des":"test","short":"test","img":"catalog\/demo_main_img.png"},"1":{"title":"test","des":"test","short":"test","img":"catalog\/demo_main_img.png"}}}'),
(69,'Footer Logo','tvcmsfooterlogo','{"name":"Footer Logo","status":1,"tvcmsfooterlogo_des":{"1":{"main_img":"catalog\/themevolty\/footerlogo\/demo_img_1.png","main_title":"themevolty","main_des":"Description","Excepteur Sint Occaecat Cupidatat Non Proident, Sunt In Culpa Qui Officia Deserunt Mollit Anim Id Est Laborum.":"Excepteur Sint Occaecat Cupidatat Non Proident, Sunt In Culpa Qui Officia Deserunt Mollit Anim Id Est Laborum.","main_short_des":"Excepteur Sint Occaecat Cupidatat Non Proident, Sunt In Culpa Qui Officia Deserunt Mollit Anim Id Est Laborum."},"2":{"main_img":"catalog\/themevolty\/footerlogo\/demo_img_1.png","main_title":"themevolty","main_des":"Description","Excepteur Sint Occaecat Cupidatat Non Proident, Sunt In Culpa Qui Officia Deserunt Mollit Anim Id Est Laborum.":"Excepteur Sint Occaecat Cupidatat Non Proident, Sunt In Culpa Qui Officia Deserunt Mollit Anim Id Est Laborum.","main_short_des":"Excepteur Sint Occaecat Cupidatat Non Proident, Sunt In Culpa Qui Officia Deserunt Mollit Anim Id Est Laborum."}}}'),
(62,'Payment Icon','tvcmspaymenticon','{"name":"Payment Icon","status":1,"tvcmspaymenticon_main":{"2":{"main_img":"catalog\/themevolty\/paymenticon\/demo_main_img.jpg","maintitle":"Main Title","main_short_des":"Short Description","main_des":"Description"},"1":{"main_img":"catalog\/themevolty\/paymenticon\/demo_main_img.jpg","maintitle":"Main Title","main_short_des":"Short Description","main_des":"Description"}}}'),
(63,'Social Icon','tvcmssocialicon','{"name":"Social Icon","status":"1","tvcmssocialicon_main":{"1":{"maintitle":"Follow Us:"},"2":{"maintitle":"Follow Us:"}}}'),
(64,'Special Product','tvcmsspecialproduct','{"name":"Special Product","status":1}'),
(65,'Tab Product','tvcmstabproducts','{"name":"Tab Product","status":1,"tvcmstabproducts_pro_fea":{"status":1,"no_pro":11,"cate_pro":["25","20","24","18","17","33","34","57"],"dis_rand":1,"dis_tap":1,"bannerside":"left","bannerstatus":0,"lang_text":{"2":{"tabtitle":"Featured","hometitle":"Featured product","homesubtitle":"Our Featured product","homedes":"our Featured product","img":"catalog\/themevolty\/tabproducts\/best_seller_offer_img_1.jpg"},"1":{"tabtitle":"Featured","hometitle":"Featured product","homesubtitle":"Our Featured product","homedes":"our Featured product","img":"catalog\/themevolty\/tabproducts\/best_seller_offer_img_1.jpg"}}},"tvcmstabproducts_pro_new":{"status":1,"no_pro":11,"cate_pro":4,"dis_tap":1,"bannerside":"left","bannerstatus":0,"lang_text":{"2":{"tabtitle":"New","hometitle":"New Product","homesubtitle":"Our New Product","homedes":"our New Product","img":"catalog\/themevolty\/tabproducts\/featured_offer_img_1.jpg"},"1":{"tabtitle":"New","hometitle":"New Product","homesubtitle":"Our New Product","homedes":"our New Product","img":"catalog\/themevolty\/tabproducts\/featured_offer_img_1.jpg"}}},"tvcmstabproducts_pro_best":{"status":1,"no_pro":11,"dis_tap":1,"bannerside":"left","bannerstatus":0,"lang_text":{"2":{"tabtitle":"Best","hometitle":"Best Product","homesubtitle":"Our best product","homedes":"our Best Product","img":"catalog\/themevolty\/tabproducts\/main_offer_img_1.jpg"},"1":{"tabtitle":"Best","hometitle":"Best Product","homesubtitle":"Our best product","homedes":"our Best Product","img":"catalog\/themevolty\/tabproducts\/main_offer_img_1.jpg"}}},"tvcmstabproducts_pro_spe":{"status":1,"no_pro":11,"dis_tap":1,"bannerside":"left","bannerstatus":0,"lang_text":{"2":{"tabtitle":"special","hometitle":"Special Trand Products","homesubtitle":"Our special product","homedes":"our special Product","img":"catalog\/themevolty\/tabproducts\/main_offer_img_1.jpg"},"1":{"tabtitle":"special","hometitle":"Special Trand Products","homesubtitle":"Our special product","homedes":"our special Product","img":"catalog\/themevolty\/tabproducts\/main_offer_img_1.jpg"}}},"tvcmstabproducts_pro_cus":{"status":1,"bannerside":"left","bannerstatus":0,"lang_text":{"2":{"maintitle":"Trending Items","subtitle":"Our Product","des":"Our product","img":"catalog\/themevolty\/tabproducts\/main_offer_img_1.jpg"},"1":{"maintitle":"Trending Items","subtitle":"Our Product","des":"Our product","img":"catalog\/themevolty\/tabproducts\/main_offer_img_1.jpg"}}}}'),
(66,'Testimonial','tvcmstestimonial','{"name":"Testimonial","status":1,"tvcmstestimonial_main":{"2":{"maintitle":"WHAT OUR CLIENTS SAY","main_short_des":"OUR TESTIMONIAL","main_des":"Description","main_img":"catalog\/themevolty\/testimonial\/demo_main_img.jpg"},"1":{"maintitle":"WHAT OUR CLIENTS SAY","main_short_des":"OUR TESTIMONIAL","main_des":"Description","main_img":"catalog\/themevolty\/testimonial\/demo_main_img.jpg"}}}'),
(67,'Two Banner','tvcmstwoofferbanner','{"status":"1","name":"Two Banner","tvcmstwoofferbanner":{"1":{"tvcmstwoofferbannersub_image_1":"catalog\/themevolty\/twobannar\/demo_img_1.jpg","tvcmstwoofferbannersub_img_cap_1":"This is Caption 1","tvcmstwoofferbannersub_link_1":"#","tvcmstwoofferbannersub_width_1":"885","tvcmstwoofferbannersub_height_1":"500","tvcmstwoofferbannersub_image_2":"catalog\/themevolty\/twobannar\/demo_img_2.jpg","tvcmstwoofferbannersub_img_cap_2":"This is Caption 2","tvcmstwoofferbannersub_link_2":"#","tvcmstwoofferbannersub_width_2":"885","tvcmstwoofferbannersub_height_2":"500"},"2":{"tvcmstwoofferbannersub_image_1":"catalog\/themevolty\/twobannar\/demo_img_1.jpg","tvcmstwoofferbannersub_img_cap_1":"This is Caption 1","tvcmstwoofferbannersub_link_1":"#","tvcmstwoofferbannersub_width_1":"885","tvcmstwoofferbannersub_height_1":"500","tvcmstwoofferbannersub_image_2":"catalog\/themevolty\/twobannar\/demo_img_2.jpg","tvcmstwoofferbannersub_img_cap_2":"This is Caption 2","tvcmstwoofferbannersub_link_2":"#","tvcmstwoofferbannersub_width_2":"885","tvcmstwoofferbannersub_height_2":"500"}}}');
...
(2, 1, 44, 'Masonite', '12', 1, '220.0000', '220.0000', '0.0000', 700),
(3, 1, 43, 'Acrylics', '11', 1, '430.0000', '430.0000', '0.0000', 600),
(4, 1, 30, 'Canvas', '2', 1, '80.0000', '80.0000', '0.0000', 200),
(5, 1, 36, 'Watercolour', '8', 1, '210.0000', '210.0000', '0.0000', 0),
(6, 1, 34, 'Oils', '9', 1, '350.0000', '350.0000', '0.0000', 0);
...
(28, '4', '', '', '', '', '', '', '', 999999, 7, 'catalog/themevolty/product/product-1.jpg', 5, 1, '310.0000', 200, 0, '2018-03-15', '146.40000000', 2, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 11, '2009-02-03 16:06:50', '2018-03-21 16:37:18'),
(30, '2', '', '', '', '', '', '', '', 999998, 7, 'catalog/themevolty/product/product-2.jpg', 9, 1, '280.0000', 0, 0, '2018-03-15', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 25, '2009-02-03 16:59:00', '2018-03-27 09:21:23'),
(32, '10', '', '', '', '', '', '', '', 999999, 7, 'catalog/themevolty/product/product-3.jpg', 8, 1, '290.0000', 0, 0, '2018-03-15', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 32, '2009-02-03 17:07:26', '2018-03-15 10:09:21'),
(34, '9', '', '', '', '', '', '', '', 999998, 7, 'catalog/themevolty/product/product-4.jpg', 8, 1, '350.0000', 0, 0, '2018-03-15', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 4, '2009-02-03 18:07:54', '2018-03-15 10:00:14'),
(36, '8', '', '', '', '', '', '', '', 999998, 7, 'catalog/themevolty/product/product-5.jpg', 8, 0, '210.0000', 100, 0, '2018-03-15', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 5, '2009-02-03 18:09:19', '2018-03-15 09:48:44'),
(40, '6', '', '', '', '', '', '', '', 999999, 7, 'catalog/themevolty/product/product-6.jpg', 8, 1, '420.0000', 0, 0, '2018-03-15', '10.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 9, '2009-02-03 21:07:12', '2018-03-21 16:41:21'),
(41, '5', '', '', '', '', '', '', '', 999999, 7, 'catalog/themevolty/product/product-7.jpg', 8, 1, '240.0000', 0, 0, '2018-03-15', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 10, '2009-02-03 21:07:26', '2018-03-21 16:40:31'),
(42, '1', '', '', '', '', '', '', '', 999999, 7, 'catalog/themevolty/product/product-8.jpg', 8, 1, '320.0000', 400, 0, '2018-03-15', '12.50000000', 1, '1.00000000', '2.00000000', '3.00000000', 1, 1, 2, 0, 1, 75, '2009-02-03 21:07:37', '2018-03-21 16:28:19'),
(43, '11', '', '', '', '', '', '', '', 999998, 7, 'catalog/themevolty/product/product-9.jpg', 8, 0, '430.0000', 0, 0, '2018-03-15', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 1, '2009-02-03 21:07:49', '2018-03-15 10:15:14'),
(44, '12', '', '', '', '', '', '', '', 999998, 7, 'catalog/themevolty/product/product-10.jpg', 8, 1, '220.0000', 0, 0, '2018-03-15', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 13, '2009-02-03 21:08:00', '2018-03-15 10:22:29'),
(47, '3', '', '', '', '', '', '', '', 999999, 7, 'catalog/themevolty/product/product-11.jpg', 7, 1, '360.0000', 400, 0, '2018-03-15', '1.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 0, 1, 0, 1, 12, '2009-02-03 21:08:40', '2018-03-21 16:32:12'),
(48, '7', 'test 1', '', '', '', '', '', 'test 2', 999999, 7, 'catalog/themevolty/product/product-12.jpg', 8, 1, '120.0000', 0, 0, '2018-03-15', '1.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, 58, '2009-02-08 17:21:51', '2018-03-27 09:37:41');
...
(30, 2, 'Canvas', 'Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis.Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis', '', 'Canvas', '', ''),
(48, 2, 'Artist Paint', '&lt;div class=&quot;cpt_product_description &quot;&gt;\r\n  &lt;div&gt;\r\n   &lt;p&gt;\r\n     &lt;strong&gt;More room to move.&lt;/strong&gt;&lt;/p&gt;\r\n   &lt;p&gt;\r\n     With 80GB or 160GB of storage and up to 40 hours of battery life, the new iPod classic lets you enjoy up to 40,000 songs or up to 200 hours of video or any combination wherever you go.&lt;/p&gt;\r\n    &lt;p&gt;\r\n     &lt;strong&gt;Cover Flow.&lt;/strong&gt;&lt;/p&gt;\r\n    &lt;p&gt;\r\n     Browse through your music collection by flipping through album art. Select an album to turn it over and see the track list.&lt;/p&gt;\r\n   &lt;p&gt;\r\n     &lt;strong&gt;Enhanced interface.&lt;/strong&gt;&lt;/p&gt;\r\n    &lt;p&gt;\r\n     Experience a whole new way to browse and view your music and video.&lt;/p&gt;\r\n   &lt;p&gt;\r\n     &lt;strong&gt;Sleeker design.&lt;/strong&gt;&lt;/p&gt;\r\n    &lt;p&gt;\r\n     Beautiful, durable, and sleeker than ever, iPod classic now features an anodized aluminum and polished stainless steel enclosure with rounded edges.&lt;/p&gt;\r\n  &lt;/div&gt;\r\n&lt;/div&gt;\r\n&lt;!-- cpt_container_end --&gt;', '', 'Artist Paint', '', ''),
(44, 1, 'Masonite', 'Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis.Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis', '', 'Masonite', '', ''),
(36, 1, 'Watercolour', '&lt;div&gt;\r\n &lt;p&gt;\r\n   &lt;strong&gt;Video in your pocket.&lt;/strong&gt;&lt;/p&gt;\r\n  &lt;p&gt;\r\n   Its the small iPod with one very big idea: video. The worlds most popular music player now lets you enjoy movies, TV shows, and more on a two-inch display thats 65% brighter than before.&lt;/p&gt;\r\n  &lt;p&gt;\r\n   &lt;strong&gt;Cover Flow.&lt;/strong&gt;&lt;/p&gt;\r\n  &lt;p&gt;\r\n   Browse through your music collection by flipping through album art. Select an album to turn it over and see the track list.&lt;strong&gt;&amp;nbsp;&lt;/strong&gt;&lt;/p&gt;\r\n  &lt;p&gt;\r\n   &lt;strong&gt;Enhanced interface.&lt;/strong&gt;&lt;/p&gt;\r\n  &lt;p&gt;\r\n   Experience a whole new way to browse and view your music and video.&lt;/p&gt;\r\n &lt;p&gt;\r\n   &lt;strong&gt;Sleek and colorful.&lt;/strong&gt;&lt;/p&gt;\r\n  &lt;p&gt;\r\n   With an anodized aluminum and polished stainless steel enclosure and a choice of five colors, iPod nano is dressed to impress.&lt;/p&gt;\r\n  &lt;p&gt;\r\n   &lt;strong&gt;iTunes.&lt;/strong&gt;&lt;/p&gt;\r\n  &lt;p&gt;\r\n   Available as a free download, iTunes makes it easy to browse and buy millions of songs, movies, TV shows, audiobooks, and games and download free podcasts all at the iTunes Store. And you can import your own music, manage your whole media library, and sync your iPod or iPhone with ease.&lt;/p&gt;\r\n&lt;/div&gt;\r\n', '', 'Watercolour', '', ''),
(32, 1, 'hardback', '&lt;p&gt;\r\n  &lt;strong&gt;Revolutionary multi-touch interface.&lt;/strong&gt;&lt;br /&gt;\r\n iPod touch features the same multi-touch screen technology as iPhone. Pinch to zoom in on a photo. Scroll through your songs and videos with a flick. Flip through your library by album artwork with Cover Flow.&lt;/p&gt;\r\n&lt;p&gt;\r\n  &lt;strong&gt;Gorgeous 3.5-inch widescreen display.&lt;/strong&gt;&lt;br /&gt;\r\n  Watch your movies, TV shows, and photos come alive with bright, vivid color on the 320-by-480-pixel display.&lt;/p&gt;\r\n&lt;p&gt;\r\n &lt;strong&gt;Music downloads straight from iTunes.&lt;/strong&gt;&lt;br /&gt;\r\n  Shop the iTunes Wi-Fi Music Store from anywhere with Wi-Fi.1 Browse or search to find the music youre looking for, preview it, and buy it with just a tap.&lt;/p&gt;\r\n&lt;p&gt;\r\n &lt;strong&gt;Surf the web with Wi-Fi.&lt;/strong&gt;&lt;br /&gt;\r\n Browse the web using Safari and watch YouTube videos on the first iPod with Wi-Fi built in&lt;br /&gt;\r\n  &amp;nbsp;&lt;/p&gt;\r\n', '', 'hardback', '', ''),
(34, 1, 'Oils', '&lt;div&gt;\r\n &lt;strong&gt;Born to be worn.&lt;/strong&gt;\r\n &lt;p&gt;\r\n   Clip on the worlds most wearable music player and take up to 240 songs with you anywhere. Choose from five colors including four new hues to make your musical fashion statement.&lt;/p&gt;\r\n &lt;p&gt;\r\n   &lt;strong&gt;Random meets rhythm.&lt;/strong&gt;&lt;/p&gt;\r\n &lt;p&gt;\r\n   With iTunes autofill, iPod shuffle can deliver a new musical experience every time you sync. For more randomness, you can shuffle songs during playback with the slide of a switch.&lt;/p&gt;\r\n &lt;strong&gt;Everything is easy.&lt;/strong&gt;\r\n  &lt;p&gt;\r\n   Charge and sync with the included USB dock. Operate the iPod shuffle controls with one hand. Enjoy up to 12 hours straight of skip-free music playback.&lt;/p&gt;\r\n&lt;/div&gt;\r\n', '', 'Oils', '', ''),
(43, 1, 'Acrylics', '&lt;div&gt;\r\n &lt;p&gt;\r\n   &lt;b&gt;Intel Core 2 Duo processor&lt;/b&gt;&lt;/p&gt;\r\n &lt;p&gt;\r\n   Powered by an Intel Core 2 Duo processor at speeds up to 2.16GHz, the new MacBook is the fastest ever.&lt;/p&gt;\r\n  &lt;p&gt;\r\n   &lt;b&gt;1GB memory, larger hard drives&lt;/b&gt;&lt;/p&gt;\r\n &lt;p&gt;\r\n   The new MacBook now comes with 1GB of memory standard and larger hard drives for the entire line perfect for running more of your favorite applications and storing growing media collections.&lt;/p&gt;\r\n  &lt;p&gt;\r\n   &lt;b&gt;Sleek, 1.08-inch-thin design&lt;/b&gt;&lt;/p&gt;\r\n &lt;p&gt;\r\n   MacBook makes it easy to hit the road thanks to its tough polycarbonate case, built-in wireless technologies, and innovative MagSafe Power Adapter that releases automatically if someone accidentally trips on the cord.&lt;/p&gt;\r\n &lt;p&gt;\r\n   &lt;b&gt;Built-in iSight camera&lt;/b&gt;&lt;/p&gt;\r\n &lt;p&gt;\r\n   Right out of the box, you can have a video chat with friends or family,2 record a video at your desk, or take fun pictures with Photo Booth&lt;/p&gt;\r\n&lt;/div&gt;\r\n', '', 'Acrylics', '', ''),
(42, 1, 'Mahl Stick', '&lt;p&gt;\r\n &lt;font face=&quot;helvetica,geneva,arial&quot; size=&quot;2&quot;&gt;&lt;font face=&quot;Helvetica&quot; size=&quot;2&quot;&gt;The 30-inch Apple Cinema HD Display delivers an amazing 2560 x 1600 pixel resolution. Designed specifically for the creative professional, this display provides more space for easier access to all the tools and palettes needed to edit, format and composite your work. Combine this display with a Mac Pro, MacBook Pro, or PowerMac G5 and there''s no limit to what you can achieve. &lt;br&gt;\r\n &lt;br&gt;\r\n  &lt;/font&gt;&lt;font face=&quot;Helvetica&quot; size=&quot;2&quot;&gt;The Cinema HD features an active-matrix liquid crystal display that produces flicker-free images that deliver twice the brightness, twice the sharpness and twice the contrast ratio of a typical CRT display. Unlike other flat panels, it''s designed with a pure digital interface to deliver distortion-free images that never need adjusting. With over 4 million digital pixels, the display is uniquely suited for scientific and technical applications such as visualizing molecular structures or analyzing geological data. &lt;br&gt;\r\n  &lt;br&gt;\r\n  &lt;/font&gt;&lt;font face=&quot;Helvetica&quot; size=&quot;2&quot;&gt;Offering accurate, brilliant color performance, the Cinema HD delivers up to 16.7 million colors across a wide gamut allowing you to see subtle nuances between colors from soft pastels to rich jewel tones. A wide viewing angle ensures uniform color from edge to edge. Apple''s ColorSync technology allows you to create custom profiles to maintain consistent color onscreen and in print. The result: You can confidently use this display in all your color-critical applications. &lt;br&gt;\r\n  &lt;br&gt;\r\n  &lt;/font&gt;&lt;font face=&quot;Helvetica&quot; size=&quot;2&quot;&gt;Housed in a new aluminum design, the display has a very thin bezel that enhances visual accuracy. Each display features two FireWire 400 ports and two USB 2.0 ports, making attachment of desktop peripherals, such as iSight, iPod, digital and still cameras, hard drives, printers and scanners, even more accessible and convenient. Taking advantage of the much thinner and lighter footprint of an LCD, the new displays support the VESA (Video Electronics Standards Association) mounting interface standard. Customers with the optional Cinema Display VESA Mount Adapter kit gain the flexibility to mount their display in locations most appropriate for their work environment. &lt;br&gt;\r\n  &lt;br&gt;\r\n  &lt;/font&gt;&lt;font face=&quot;Helvetica&quot; size=&quot;2&quot;&gt;The Cinema HD features a single cable design with elegant breakout for the USB 2.0, FireWire 400 and a pure digital connection using the industry standard Digital Video Interface (DVI) interface. The DVI connection allows for a direct pure-digital connection.&lt;br&gt;\r\n  &lt;/font&gt;&lt;/font&gt;&lt;/p&gt;\r\n&lt;h3&gt;\r\n  Features:&lt;/h3&gt;\r\n&lt;p&gt;\r\n Unrivaled display performance&lt;/p&gt;\r\n&lt;ul&gt;\r\n &lt;li&gt;\r\n    30-inch (viewable) active-matrix liquid crystal display provides breathtaking image quality and vivid, richly saturated color.&lt;/li&gt;\r\n &lt;li&gt;\r\n    Support for 2560-by-1600 pixel resolution for display of high definition still and video imagery.&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Wide-format design for simultaneous display of two full pages of text and graphics.&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Industry standard DVI connector for direct attachment to Mac- and Windows-based desktops and notebooks&lt;/li&gt;\r\n &lt;li&gt;\r\n    Incredibly wide (170 degree) horizontal and vertical viewing angle for maximum visibility and color performance.&lt;/li&gt;\r\n &lt;li&gt;\r\n    Lightning-fast pixel response for full-motion digital video playback.&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Support for 16.7 million saturated colors, for use in all graphics-intensive applications.&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n Simple setup and operation&lt;/p&gt;\r\n&lt;ul&gt;\r\n  &lt;li&gt;\r\n    Single cable with elegant breakout for connection to DVI, USB and FireWire ports&lt;/li&gt;\r\n &lt;li&gt;\r\n    Built-in two-port USB 2.0 hub for easy connection of desktop peripheral devices.&lt;/li&gt;\r\n &lt;li&gt;\r\n    Two FireWire 400 ports to support iSight and other desktop peripherals&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n Sleek, elegant design&lt;/p&gt;\r\n&lt;ul&gt;\r\n &lt;li&gt;\r\n    Huge virtual workspace, very small footprint.&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Narrow Bezel design to minimize visual impact of using dual displays&lt;/li&gt;\r\n &lt;li&gt;\r\n    Unique hinge design for effortless adjustment&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Support for VESA mounting solutions (Apple Cinema Display VESA Mount Adapter sold separately)&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;h3&gt;\r\n Technical specifications&lt;/h3&gt;\r\n&lt;p&gt;\r\n  &lt;b&gt;Screen size (diagonal viewable image size)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n &lt;li&gt;\r\n    Apple Cinema HD Display: 30 inches (29.7-inch viewable)&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n  &lt;b&gt;Screen type&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n  &lt;li&gt;\r\n    Thin film transistor (TFT) active-matrix liquid crystal display (AMLCD)&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n  &lt;b&gt;Resolutions&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n  &lt;li&gt;\r\n    2560 x 1600 pixels (optimum resolution)&lt;/li&gt;\r\n  &lt;li&gt;\r\n    2048 x 1280&lt;/li&gt;\r\n  &lt;li&gt;\r\n    1920 x 1200&lt;/li&gt;\r\n  &lt;li&gt;\r\n    1280 x 800&lt;/li&gt;\r\n &lt;li&gt;\r\n    1024 x 640&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n &lt;b&gt;Display colors (maximum)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n &lt;li&gt;\r\n    16.7 million&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n &lt;b&gt;Viewing angle (typical)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n  &lt;li&gt;\r\n    170° horizontal; 170° vertical&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n &lt;b&gt;Brightness (typical)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n &lt;li&gt;\r\n    30-inch Cinema HD Display: 400 cd/m2&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n &lt;b&gt;Contrast ratio (typical)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n &lt;li&gt;\r\n    700:1&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n  &lt;b&gt;Response time (typical)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n  &lt;li&gt;\r\n    16 ms&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n  &lt;b&gt;Pixel pitch&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n  &lt;li&gt;\r\n    30-inch Cinema HD Display: 0.250 mm&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n  &lt;b&gt;Screen treatment&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n &lt;li&gt;\r\n    Antiglare hardcoat&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n &lt;b&gt;User controls (hardware and software)&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n  &lt;li&gt;\r\n    Display Power,&lt;/li&gt;\r\n &lt;li&gt;\r\n    System sleep, wake&lt;/li&gt;\r\n &lt;li&gt;\r\n    Brightness&lt;/li&gt;\r\n &lt;li&gt;\r\n    Monitor tilt&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n &lt;b&gt;Connectors and cables&lt;/b&gt;&lt;br&gt;\r\n  Cable&lt;/p&gt;\r\n&lt;ul&gt;\r\n &lt;li&gt;\r\n    DVI (Digital Visual Interface)&lt;/li&gt;\r\n &lt;li&gt;\r\n    FireWire 400&lt;/li&gt;\r\n &lt;li&gt;\r\n    USB 2.0&lt;/li&gt;\r\n  &lt;li&gt;\r\n    DC power (24 V)&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n  Connectors&lt;/p&gt;\r\n&lt;ul&gt;\r\n  &lt;li&gt;\r\n    Two-port, self-powered USB 2.0 hub&lt;/li&gt;\r\n &lt;li&gt;\r\n    Two FireWire 400 ports&lt;/li&gt;\r\n &lt;li&gt;\r\n    Kensington security port&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n &lt;b&gt;VESA mount adapter&lt;/b&gt;&lt;br&gt;\r\n Requires optional Cinema Display VESA Mount Adapter (M9649G/A)&lt;/p&gt;\r\n&lt;ul&gt;\r\n  &lt;li&gt;\r\n    Compatible with VESA FDMI (MIS-D, 100, C) compliant mounting solutions&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n &lt;b&gt;Electrical requirements&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n  &lt;li&gt;\r\n    Input voltage: 100-240 VAC 50-60Hz&lt;/li&gt;\r\n &lt;li&gt;\r\n    Maximum power when operating: 150W&lt;/li&gt;\r\n &lt;li&gt;\r\n    Energy saver mode: 3W or less&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n  &lt;b&gt;Environmental requirements&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n &lt;li&gt;\r\n    Operating temperature: 50° to 95° F (10° to 35° C)&lt;/li&gt;\r\n &lt;li&gt;\r\n    Storage temperature: -40° to 116° F (-40° to 47° C)&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Operating humidity: 20% to 80% noncondensing&lt;/li&gt;\r\n &lt;li&gt;\r\n    Maximum operating altitude: 10,000 feet&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n  &lt;b&gt;Agency approvals&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n &lt;li&gt;\r\n    FCC Part 15 Class B&lt;/li&gt;\r\n  &lt;li&gt;\r\n    EN55022 Class B&lt;/li&gt;\r\n  &lt;li&gt;\r\n    EN55024&lt;/li&gt;\r\n  &lt;li&gt;\r\n    VCCI Class B&lt;/li&gt;\r\n &lt;li&gt;\r\n    AS/NZS 3548 Class B&lt;/li&gt;\r\n  &lt;li&gt;\r\n    CNS 13438 Class B&lt;/li&gt;\r\n  &lt;li&gt;\r\n    ICES-003 Class B&lt;/li&gt;\r\n &lt;li&gt;\r\n    ISO 13406 part 2&lt;/li&gt;\r\n &lt;li&gt;\r\n    MPR II&lt;/li&gt;\r\n &lt;li&gt;\r\n    IEC 60950&lt;/li&gt;\r\n  &lt;li&gt;\r\n    UL 60950&lt;/li&gt;\r\n &lt;li&gt;\r\n    CSA 60950&lt;/li&gt;\r\n  &lt;li&gt;\r\n    EN60950&lt;/li&gt;\r\n  &lt;li&gt;\r\n    ENERGY STAR&lt;/li&gt;\r\n  &lt;li&gt;\r\n    TCO ''03&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n &lt;b&gt;Size and weight&lt;/b&gt;&lt;br&gt;\r\n  30-inch Apple Cinema HD Display&lt;/p&gt;\r\n&lt;ul&gt;\r\n &lt;li&gt;\r\n    Height: 21.3 inches (54.3 cm)&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Width: 27.2 inches (68.8 cm)&lt;/li&gt;\r\n &lt;li&gt;\r\n    Depth: 8.46 inches (21.5 cm)&lt;/li&gt;\r\n &lt;li&gt;\r\n    Weight: 27.5 pounds (12.5 kg)&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;p&gt;\r\n  &lt;b&gt;System Requirements&lt;/b&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n  &lt;li&gt;\r\n    Mac Pro, all graphic options&lt;/li&gt;\r\n &lt;li&gt;\r\n    MacBook Pro&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Power Mac G5 (PCI-X) with ATI Radeon 9650 or better or NVIDIA GeForce 6800 GT DDL or better&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Power Mac G5 (PCI Express), all graphics options&lt;/li&gt;\r\n &lt;li&gt;\r\n    PowerBook G4 with dual-link DVI support&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Windows PC and graphics card that supports DVI ports with dual-link digital bandwidth and VESA DDC standard for plug-and-play setup&lt;/li&gt;\r\n&lt;/ul&gt;\r\n', '', 'Mahl Stick', '', ''),
(30, 1, 'Canvas', 'Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis.Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis', '', 'Canvas', '', ''),
(47, 2, 'Cas Meque Metus', 'Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis.Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis', '', 'Cas Meque Metus', '', ''),
(47, 1, 'Cas Meque Metus', 'Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis.Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis', '', 'Cas Meque Metus', '', ''),
(28, 1, 'Paint Brushes', '&lt;p&gt;\r\n HTC Touch - in High Definition. Watch music videos and streaming content in awe-inspiring high definition clarity for a mobile experience you never thought possible. Seductively sleek, the HTC Touch HD provides the next generation of mobile functionality, all at a simple touch. Fully integrated with Windows Mobile Professional 6.1, ultrafast 3.5G, GPS, 5MP camera, plus lots more - all delivered on a breathtakingly crisp 3.8&amp;quot; WVGA touchscreen - you can take control of your mobile world with the HTC Touch HD.&lt;/p&gt;\r\n&lt;p&gt;\r\n  &lt;strong&gt;Features&lt;/strong&gt;&lt;/p&gt;\r\n&lt;ul&gt;\r\n &lt;li&gt;\r\n    Processor Qualcomm&amp;reg; MSM 7201A&amp;trade; 528 MHz&lt;/li&gt;\r\n &lt;li&gt;\r\n    Windows Mobile&amp;reg; 6.1 Professional Operating System&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Memory: 512 MB ROM, 288 MB RAM&lt;/li&gt;\r\n &lt;li&gt;\r\n    Dimensions: 115 mm x 62.8 mm x 12 mm / 146.4 grams&lt;/li&gt;\r\n &lt;li&gt;\r\n    3.8-inch TFT-LCD flat touch-sensitive screen with 480 x 800 WVGA resolution&lt;/li&gt;\r\n  &lt;li&gt;\r\n    HSDPA/WCDMA: Europe/Asia: 900/2100 MHz; Up to 2 Mbps up-link and 7.2 Mbps down-link speeds&lt;/li&gt;\r\n &lt;li&gt;\r\n    Quad-band GSM/GPRS/EDGE: Europe/Asia: 850/900/1800/1900 MHz (Band frequency, HSUPA availability, and data speed are operator dependent.)&lt;/li&gt;\r\n &lt;li&gt;\r\n    Device Control via HTC TouchFLO&amp;trade; 3D &amp;amp; Touch-sensitive front panel buttons&lt;/li&gt;\r\n  &lt;li&gt;\r\n    GPS and A-GPS ready&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Bluetooth&amp;reg; 2.0 with Enhanced Data Rate and A2DP for wireless stereo headsets&lt;/li&gt;\r\n &lt;li&gt;\r\n    Wi-Fi&amp;reg;: IEEE 802.11 b/g&lt;/li&gt;\r\n  &lt;li&gt;\r\n    HTC ExtUSB&amp;trade; (11-pin mini-USB 2.0)&lt;/li&gt;\r\n  &lt;li&gt;\r\n    5 megapixel color camera with auto focus&lt;/li&gt;\r\n &lt;li&gt;\r\n    VGA CMOS color camera&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Built-in 3.5 mm audio jack, microphone, speaker, and FM radio&lt;/li&gt;\r\n  &lt;li&gt;\r\n    Ring tone formats: AAC, AAC+, eAAC+, AMR-NB, AMR-WB, QCP, MP3, WMA, WAV&lt;/li&gt;\r\n  &lt;li&gt;\r\n    40 polyphonic and standard MIDI format 0 and 1 (SMF)/SP MIDI&lt;/li&gt;\r\n &lt;li&gt;\r\n    Rechargeable Lithium-ion or Lithium-ion polymer 1350 mAh battery&lt;/li&gt;\r\n &lt;li&gt;\r\n    Expansion Slot: microSD&amp;trade; memory card (SD 2.0 compatible)&lt;/li&gt;\r\n &lt;li&gt;\r\n    AC Adapter Voltage range/frequency: 100 ~ 240V AC, 50/60 Hz DC output: 5V and 1A&lt;/li&gt;\r\n &lt;li&gt;\r\n    Special Features: FM Radio, G-Sensor&lt;/li&gt;\r\n&lt;/ul&gt;\r\n', '', 'Paint Brushes', '', ''),
(40, 2, 'Etiam Gravida', 'Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis.Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis', '', 'Etiam Gravida', '', ''),
(40, 1, 'Etiam Gravida', 'Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis.Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis', '', 'Etiam Gravida', '', ''),
(44, 2, 'Masonite', 'Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis.Nunc facilisis sagittis ullamcorper. Generic Multi Vegetable, gravida et mattis vulputate, tristique ut lectus. Sed et lorem nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean eleifend laoreet congue. Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer enim purus, posuere at ultricies eu, placerat a felis. Suspendisse aliquet urna pretium eros convallis interdum. Quisque in arcu id dui vulputate mollis eget non arcu. Aenean et nulla purus. Mauris vel tellus non nunc mattis lobortis', '', 'Masonite', '', '');
...
(2445, 30, 'catalog/themevolty/product/product-1.jpg', 0),
(2421, 47, 'catalog/themevolty/product/product-2.jpg', 0),
(2427, 28, 'catalog/themevolty/product/product-3.jpg', 0),
(2432, 41, 'catalog/themevolty/product/product-4.jpg', 0),
(2437, 40, 'catalog/themevolty/product/product-5.jpg', 1),
(2386, 36, 'catalog/themevolty/product/product-6.jpg', 0),
(2385, 36, 'catalog/themevolty/product/product-7.jpg', 0),
(2391, 34, 'catalog/themevolty/product/product-8.jpg', 0),
(2390, 34, 'catalog/themevolty/product/product-9.jpg', 0),
(2397, 32, 'catalog/themevolty/product/product-10.jpg', 0),
(2396, 32, 'catalog/themevolty/product/product-11.jpg', 0),
(2395, 32, 'catalog/themevolty/product/product-12.jpg', 0),
(2401, 43, 'catalog/themevolty/product/product-13.jpg', 0),
(2400, 43, 'catalog/themevolty/product/product-14.jpg', 0),
(2404, 44, 'catalog/themevolty/product/product-1.jpg', 0),
(2403, 44, 'catalog/themevolty/product/product-2.jpg', 0),
(2455, 48, 'catalog/themevolty/product/product-3.jpg', 0),
(2436, 40, 'catalog/themevolty/product/product-4.jpg', 0),
(2435, 40, 'catalog/themevolty/product/product-5.jpg', 0),
(2426, 28, 'catalog/themevolty/product/product-6.jpg', 0),
(2431, 41, 'catalog/themevolty/product/product-7.jpg', 0),
(2434, 40, 'catalog/themevolty/product/product-8.jpg', 0),
(2433, 40, 'catalog/themevolty/product/product-9.jpg', 0),
(2384, 36, 'catalog/themevolty/product/product-10.jpg', 0),
(2383, 36, 'catalog/themevolty/product/product-11.jpg', 1),
(2389, 34, 'catalog/themevolty/product/product-12.jpg', 0),
(2388, 34, 'catalog/themevolty/product/product-13.jpg', 1),
(2394, 32, 'catalog/themevolty/product/product-14.jpg', 0),
(2393, 32, 'catalog/themevolty/product/product-1.jpg', 0),
(2392, 32, 'catalog/themevolty/product/product-2.jpg', 1),
(2399, 43, 'catalog/themevolty/product/product-3.jpg', 0),
(2398, 43, 'catalog/themevolty/product/product-4.jpg', 1),
(2402, 44, 'catalog/themevolty/product/product-5.jpg', 1),
(2422, 47, 'catalog/themevolty/product/product-6.jpg', 0),
(2414, 42, 'catalog/themevolty/product/product-7.jpg', 0),
(2413, 42, 'catalog/themevolty/product/product-8.jpg', 0),
(2412, 42, 'catalog/themevolty/product/product-9.jpg', 0),
(2411, 42, 'catalog/themevolty/product/product-10.jpg', 1),
(2410, 42, 'catalog/themevolty/product/product-11.jpg', 0),
(2444, 30, 'catalog/themevolty/product/product-12.jpg', 0),
(2443, 30, 'catalog/themevolty/product/product-13.jpg', 0),
(2420, 47, 'catalog/themevolty/product/product-14.jpg', 0),
(2425, 28, 'catalog/themevolty/product/product-1.jpg', 0),
(2424, 28, 'catalog/themevolty/product/product-2.jpg', 1),
(2423, 28, 'catalog/themevolty/product/product-3.jpg', 0),
(2430, 41, 'catalog/themevolty/product/product-4.jpg', 0),
(2429, 41, 'catalog/themevolty/product/product-5.jpg', 1),
(2428, 41, 'catalog/themevolty/product/product-6.jpg', 0),
(2387, 36, 'catalog/themevolty/product/product-7.jpg', 0),
(2446, 30, 'catalog/themevolty/product/product-8.jpg', 0),
(2447, 30, 'catalog/themevolty/product/product-9.jpg', 0),
(2456, 48, 'catalog/themevolty/product/product-10.jpg', 0),
(2454, 48, 'catalog/themevolty/product/product-11.jpg', 1);
...
(18, 227, 30, 13, 50, 0, 1, '50.0000', '+', 50, '+', '1000.00000000', '+'),
(17, 227, 30, 13, 49, 0, 1, '60.0000', '+', 60, '+', '1000.00000000', '+'),
(10, 223, 42, 2, 44, 2696, 1, '30.0000', '+', 0, '+', '30.00000000', '+'),
(7, 218, 42, 1, 43, 300, 1, '30.0000', '+', 3, '+', '30.00000000', '+'),
(19, 227, 30, 13, 51, 0, 1, '40.0000', '+', 40, '+', '1000.00000000', '+'),
(16, 226, 30, 5, 40, 5, 1, '0.0000', '+', 0, '+', '0.00000000', '+'),
(15, 226, 30, 5, 39, 1, 1, '0.0000', '+', 0, '+', '0.00000000', '+'),
(21, 228, 48, 13, 50, 3, 1, '50.0000', '+', 50, '+', '1000.00000000', '+'),
(23, 228, 48, 13, 53, 2, 1, '30.0000', '+', 30, '+', '1000.00000000', '+'),
(20, 228, 48, 13, 49, 1, 1, '60.0000', '+', 60, '+', '1000.00000000', '+'),
(22, 228, 48, 13, 51, 4, 1, '40.0000', '+', 40, '+', '1000.00000000', '+'),
(24, 228, 48, 13, 54, 5, 1, '20.0000', '+', 20, '+', '1000.00000000', '+');
...
(446, 42, 1, 1, '120.0000', '2018-01-11', '2021-01-11'),
(448, 28, 1, 1, '120.0000', '2018-02-15', '2022-02-22'),
(451, 30, 1, 1, '80.0000', '2018-03-25', '2023-03-25'),
(449, 41, 1, 1, '80.0000', '2018-04-19', '2024-04-05'),
(444, 32, 1, 1, '150.0000', '2018-05-28', '2024-05-15');
...
(0,'config','config_encryption','',0),
...
(0,'config','config_icon','catalog/themevolty/logo/Favicon.png',0),
(0,'config','config_logo','catalog/themevolty/logo/demo_img_1.png',0),
...
(0,'config','config_fraud_status_id','7',0),
...
(0,'config','config_email','demo@demo.com',0),
...
(0,'theme_default','theme_default_image_cart_height','167',0),
(0,'theme_default','theme_default_image_cart_width','125',0),
...
(0,'theme_default','theme_default_image_popup_height','1065',0),
(0,'theme_default','theme_default_image_product_width','336',0),
(0,'theme_default','theme_default_image_product_height','448',0),
(0,'theme_default','theme_default_image_additional_width','336',0),
(0,'theme_default','theme_default_image_additional_height','448',0),
(0,'theme_default','theme_default_image_related_width','336',0),
...
(0,'theme_default','theme_default_image_related_height','448',0),
(0,'theme_default','theme_default_image_thumb_height','1065',0),
(0,'theme_default','theme_default_image_thumb_width','800',0),
(0,'theme_default','theme_default_image_category_width','1800',0),
(0,'theme_default','theme_default_image_category_height','500',0),
...
(0,'theme_default','theme_default_directory','opc_art_king_1101',0),
(0,'module_information','module_information_status','1',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_background_style_sheet','',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_testimonial_sing_img_height','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_testimonial_sing_img_width','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_testimonial_img_width','60',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_testimonial_img_height','60',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_testimonial_mainimg_width','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_testimonial_mainimg_height','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tabproduct_img_height','333',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tabproduct_img_width','250',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tabproduct_mainimg_height','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmssingleblock_img_height','630',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tabproduct_mainimg_width','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmssingleblock_img_width','720',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_sliderimage_img_height','940',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_sliderimage_img_width','1800',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_special_img_height','333',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_specialproduct_mainimg_height','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_special_img_width','250',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_specialproduct_mainimg_width','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_social_img_height','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_social_img_width','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsproductgridimg_img_width','800',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsproductgridimg_img_height','1067',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_payment_img_width','32',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_payment_img_height','32',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_payment_mainimg_height','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_payment_mainimg_width','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_offerbanner_img_height','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_offerbanner_img_width','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_lefttestimonial_img_height','250',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_lefttestimonial_img_width','250',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_leftproduct_img_height','380',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_leftproduct_img_width','345',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_leftbanner_img_height','523',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_leftbanner_img_width','322',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsnewsletterpobgimg_img_height','444',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsnewsletterpobgimg_img_width','306',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsnewsletterpoimg_img_height','400',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsnewsletterpoimg_img_width','342',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_newproduct_mainimg_height','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_newproduct_mainimg_width','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_footerproduct_height','49',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_footerproduct_width','125',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_footerlogo_img_height','49',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_footerlogo_img_width','187',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_featureproduct_mainimg_height','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_featureproduct_mainimg_width','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_customerservice_img_height','33',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_customerservice_img_width','38',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_customerservice_mainimg_height','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_customerservice_mainimg_width','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_categoryslider_img_height','120',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_categoryslider_img_width','150',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_categoryslider_mainimg_height','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_categoryslider_mainimg_width','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsblogfeasin_img_height','564',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsblogfeasin_img_width','770',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsblogfeaall_img_height','564',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsblogfeaall_img_width','770',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsblogfeahome_img_height','340',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsblogfeahome_img_width','580',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsbloggallsin_img_height','564',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsbloggallsin_img_width','770',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsbloggallall_img_height','564',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_advanceblock_sub_mainimg_width','375',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_advanceblock_sub_mainimg_height','350',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_advanceblock_img_width','73',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_advanceblock_img_height','72',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_brand_mainimg_width','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_status','1',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_configuration','{"themeoption":"theme1","customthemecolor":"","boxlayout":"0","backgroundthemecolor":"","backgroundpattern":"pattern10.png","themeoptionstatus":"1","pageloader":"1","mousehoverimage":"1","tabproductdoublerow":"1","mainmenustickystatus":"1","doublerow":"1","htmlminify":"1","comparedisplay":"1","wishlistdisplay":"1","bloglimit":"3","searchlimit":"5"}',1),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsbloggallall_img_width','770',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_brand_img_width','110',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_brand_img_height','110',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_bestproduct_mainimg_width','250',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_bestproduct_mainimg_height','333',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsbloggallhome_img_width','580',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_tvcmsbloggallhome_img_height','340',0),
...
(0,'tvcmscustomsetting','tvcmscustomsetting_brand_mainimg_height','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_advanceblock_mainimg_width','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_advanceblock_mainimg_height','200',0),
(0,'tvcmscustomsetting','tvcmscustomsetting_custommain','{"copyrighttextstatus":"1"}',1),
(0,'tvcmscustomsetting','tvcmscustomsetting_customsub','{"lang_text":{"1":{"text":"© 2019 - Ecommerce software by Opencart™","link":"#","newslettertitle":"newsletter","newslettersubtitle":"Subscribe to our email newsletter today to receive update on the latest news"},"2":{"text":"© 2019 - Ecommerce software by Opencart™","link":"#","newslettertitle":"newsletter","newslettersubtitle":"Subscribe to our email newsletter today to receive update on the latest news"}}}',1);
...
(836, 0, 1, 'category_id=20', 'Drawing'),
(834, 0, 1, 'category_id=26', 'Art Brut'),
(835, 0, 1, 'category_id=27', 'Ceramics'),
...
(775, 0, 1, 'category_id=46', 'Casual Shoes'),
(776, 0, 1, 'category_id=45', 'Junk Art'),
...
(785, 0, 1, 'category_id=57', 'Painting'),
(786, 0, 1, 'category_id=17', 'Calligraphy'),
...
INSERT INTO `oc_tvcmsblogcategory_main` SET 
        tvcmsblogcategory_status              = 1,  
        tvcmsblogcategory_featureimage        = 'catalog/themevolty/blog/blogimage/demo_img_1.png',
        tvcmsblogcategory_deafultcategory     = 1,
        tvcmsblogcategory_urlrewrite          = '#',
        tvcmsblogcategory_pos                 = 1;
INSERT INTO `oc_tvcmsblogcategory_sub` SET 
          tvcmsblogcategory_id                = '1',
          ...
          tvcmsblogcategory_sublang_id        = 1;
INSERT INTO `oc_tvcmsblogcategory_sub` SET 
          tvcmsblogcategory_id                = '1',
          tvcmsblogcategory_sub_title         = 'Fashion',
          tvcmsblogcategory_sub_categorydes   = '',
          ...
          tvcmsblogcategory_sub_metades       = '',
          tvcmsblogcategory_sub_metakeyword   = '',
          tvcmsblogcategory_sublang_id        = 2;   
INSERT INTO `oc_tvcmsblogcategory_main` SET 
        tvcmsblogcategory_status          = 1,  
        tvcmsblogcategory_featureimage    = 'catalog/themevolty/blog/blogimage/demo_img_2.png',
        tvcmsblogcategory_deafultcategory = 1,
        tvcmsblogcategory_urlrewrite      = '#',
        tvcmsblogcategory_pos             = 2;
INSERT INTO `oc_tvcmsblogcategory_sub` SET 
          tvcmsblogcategory_id                = '2',
          tvcmsblogcategory_sub_title         = 'Clothes',
          tvcmsblogcategory_sub_categorydes   = '',
          tvcmsblogcategory_sub_metatitle     = '',
          tvcmsblogcategory_sub_metades       = '',
          tvcmsblogcategory_sub_metakeyword   = '',
...
INSERT INTO `oc_tvcmsblogcategory_main` SET 
        tvcmsblogcategory_status          = 1,  
        tvcmsblogcategory_featureimage    = 'catalog/themevolty/blog/blogimage/demo_img_3.png',
        tvcmsblogcategory_deafultcategory = 1,
        tvcmsblogcategory_urlrewrite      = '#',
        tvcmsblogcategory_pos             = 3;
INSERT INTO `oc_tvcmsblogcategory_sub` SET 
          tvcmsblogcategory_id                = '3',
          tvcmsblogcategory_sub_title         = 'Clothes',
          tvcmsblogcategory_sub_categorydes   = '',
          tvcmsblogcategory_sub_metatitle     = '',
          tvcmsblogcategory_sub_metades       = '',
...
INSERT INTO `oc_tvcmsblogcategory_main` SET 
        tvcmsblogcategory_status          = 1,  
        tvcmsblogcategory_featureimage    = 'catalog/themevolty/blog/blogimage/demo_img_4.png',
        tvcmsblogcategory_deafultcategory = 1,
        tvcmsblogcategory_urlrewrite      = '#',
        tvcmsblogcategory_pos             = 4;
INSERT INTO `oc_tvcmsblogcategory_sub` SET 
          tvcmsblogcategory_id                = '4',
          tvcmsblogcategory_sub_title         = 'Clothes',
          tvcmsblogcategory_sub_categorydes   = '',
          tvcmsblogcategory_sub_metatitle     = '',
          tvcmsblogcategory_sub_metades       = '',
...
INSERT INTO `oc_tvcmsblog_main` SET 
        tvcmsblog_main_status           = 1,  
        tvcmsblog_main_posttype         = 'standrad',
        tvcmsblog_main_featureimage     = 'catalog/themevolty/blog/blogimage/demo_img_1.jpg',
        tvcmsblog_main_deafultcategory  = 1,
        tvcmsblog_main_urlrewrite       = 'this-is-secound-post-for-cmsblog',
        tvcmsblog_main_video            = '',
        tvcmsblog_main_commentstatus    = 1,
        tvcmsblog_main_adddate          = NOW(),
        tvcmsblog_main_pos              = 1;        
INSERT INTO `oc_tvcmsblog_sub` SET 
          tvcmsblog_main_id         = 1,
          tvcmsblog_sub_title       = 'This is Second Post For Template',
          tvcmsblog_sub_excerpt     = 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.',
          ...
          tvcmsblog_sub_metades     = 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.',
          tvcmsblog_sub_metakeyword   = 'Lorem,Ipsum,simply,dummy',
          tvcmsblog_sublang_id    = 1;
INSERT INTO `oc_tvcmsblog_sub` SET 
          tvcmsblog_main_id         = 1,
          tvcmsblog_sub_title       = 'This is Second Post For Template',
          tvcmsblog_sub_excerpt     = 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.',
          ...
          tvcmsblog_sub_metades     = 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.',
          tvcmsblog_sub_metakeyword   = 'Lorem,Ipsum,simply,dummy',
          tvcmsblog_sublang_id    = 2;

INSERT INTO `oc_tvcmsblog_main` SET 
        tvcmsblog_main_status           = 1,  
        tvcmsblog_main_posttype         = 'video',
        tvcmsblog_main_featureimage     = 'catalog/themevolty/blog/blogimage/demo_img_2.jpg',
        tvcmsblog_main_deafultcategory  = 1,
        tvcmsblog_main_urlrewrite       = 'this-is-secound-post-for-cmsblog',
        tvcmsblog_main_video            = 'https://www.youtube.com/embed/8keiGMJ-Z0U',
        tvcmsblog_main_commentstatus    = 1,
        tvcmsblog_main_adddate          = NOW(),
        tvcmsblog_main_pos              = 2;        
INSERT INTO `oc_tvcmsblog_sub` SET 
          tvcmsblog_main_id         = 2,
          tvcmsblog_sub_title       = 'This is Second Post For Template',
          tvcmsblog_sub_excerpt     = 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.',
...
INSERT INTO `oc_tvcmsblog_main` SET 
        tvcmsblog_main_status           = 1,  
        tvcmsblog_main_posttype         = 'gallery',
        tvcmsblog_main_featureimage     = 'catalog/themevolty/blog/blogimage/demo_img_3.jpg',
        tvcmsblog_main_deafultcategory  = 1,
        tvcmsblog_main_urlrewrite       = 'this-is-secound-post-for-cmsblog',
        tvcmsblog_main_video            = '',
        tvcmsblog_main_commentstatus    = 1,
        tvcmsblog_main_adddate          = NOW(),
        tvcmsblog_main_pos              = 3;        
INSERT INTO `oc_tvcmsblog_sub` SET 
          tvcmsblog_main_id         = 3,
          tvcmsblog_sub_title       = 'This is Second Post For Template',
          tvcmsblog_sub_excerpt     = 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.',
...
INSERT INTO `oc_tvcmsblog_main` SET 
        tvcmsblog_main_status           = 1,  
        tvcmsblog_main_posttype         = 'gallery',
        tvcmsblog_main_featureimage     = 'catalog/themevolty/blog/blogimage/demo_img_4.jpg',
        tvcmsblog_main_deafultcategory  = 1,
        tvcmsblog_main_urlrewrite       = 'this-is-secound-post-for-cmsblog',
        tvcmsblog_main_video            = '',
        tvcmsblog_main_commentstatus    = 1,
...
INSERT INTO `oc_tvcmsblog_sub` SET 
          ...
          tvcmsblog_sub_metakeyword  = 'Lorem,Ipsum,simply,dummy',
          tvcmsblog_sublang_id       = 2;
INSERT INTO `oc_tvcmsblog_gallery` SET 
        tvcmsblog_id  = 3,  
        image         = 'catalog/themevolty/blog/blogimage/demo_img_4.jpg'; 
INSERT INTO `oc_tvcmsblog_gallery` SET 
        tvcmsblog_id  = 3,  
        image         = 'catalog/themevolty/blog/blogimage/demo_img_3.jpg';
INSERT INTO `oc_tvcmsblog_gallery` SET 
        tvcmsblog_id  = 3,  
        image         = 'catalog/themevolty/blog/blogimage/demo_img_2.jpg';
INSERT INTO `oc_tvcmsblog_main` SET 
        tvcmsblog_main_status           = 1,  
        tvcmsblog_main_posttype         = 'standrad',
        tvcmsblog_main_featureimage     = 'catalog/themevolty/blog/blogimage/demo_img_3.jpg',
...
INSERT INTO `oc_tvcmsblog_sub` SET 
          ...
          tvcmsblog_sub_metakeyword  = 'Lorem,Ipsum,simply,dummy',
          tvcmsblog_sublang_id       = 2;
INSERT INTO `oc_tvcmsblog_comment` SET 
          tvcmsblog_id                    = '1',
          tvcmsblog_comment_name          = 'Demo',
          tvcmsblog_comment_email         = 'Demo@demo.com',
          tvcmsblog_comment_website_url   = 'www.com',
          tvcmsblog_comment_subject       = 'test',
          tvcmsblog_comment_comment       = 'We are a global housewares product design company. We bring thought and creativity to everyday items through original',
          tvcmsblog_comment_adddate       = NOW(),
          tvcmsblog_comment_pos           = 1,
          tvcmsblog_comment_status        = 1;
INSERT INTO `oc_tvcmsblog_comment` SET 
          tvcmsblog_id                    = '2',
          tvcmsblog_comment_name          = 'Demo',
          tvcmsblog_comment_email         = 'Demo@demo.com',
...
INSERT INTO `oc_tvcmsblog_comment` SET 
          ...
          tvcmsblog_comment_comment       = 'We are a global housewares product design company. We bring thought and creativity to everyday items through original',
          tvcmsblog_comment_adddate       = NOW(),
          tvcmsblog_comment_pos           = 4,
          tvcmsblog_comment_status        = 1;

INSERT INTO `oc_tvcmsnewsletter` SET 
  tvcmsnewsletter_email     = 'demo@demo.com',
  tvcmsnewsletter_adddate   = NOW();
INSERT INTO `oc_tvcmsnewsletter` SET 
  tvcmsnewsletter_email     = 'test@demo.com',
  tvcmsnewsletter_adddate   = NOW();
INSERT INTO `oc_tvcmsnewsletter` SET 
  tvcmsnewsletter_email     = 'new@demo.com',
  tvcmsnewsletter_adddate   = NOW();
INSERT INTO `oc_tvcmsnewsletter` SET 
  tvcmsnewsletter_email     = 'old@demo.com',
  tvcmsnewsletter_adddate   = NOW();
