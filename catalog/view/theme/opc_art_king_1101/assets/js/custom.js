...
$(document).ready(function() {
	...
	function showView(){
		if (document.body.clientWidth <= mobileViewSize) {//for mobile view
			 ...
			 moveDataInMobileView('#ttvdesktop-header-myaccount-wrapper', '#ttvmobile-header-myaccount-wrapper');
			...
			moveDataInDesktopView('#ttvdesktop-header-myaccount-wrapper', '#ttvmobile-header-myaccount-wrapper');
