...
class ControllerExtensionModuletvcmsblog extends Controller {
	...
	public function install(){
        ...
        foreach ($languages as $value) {
			$main['tvcmsblog_main'][$value['language_id']] = array('title' => "From The Blog",'subtitle' => "Mirum est notare quam littera gothica, quam nunc putamus parum claram anteposuerit litterarum formas.",'des' => "Antic Jewellery");
		}
