...
class ControllerExtensionModuletvcmscustomsetting extends Controller {
	...
	public function install(){
        ...
        $main['tvcmscustomsetting_configuration']['backgroundpattern'] 		= 'pattern10.png';
        ...
        $main['tvcmscustomsetting_configuration']['doublerow']				= '0';
		...
		$main['tvcmscustomsetting_brand_img_width'] 						= 110;
		$main['tvcmscustomsetting_brand_img_height'] 						= 110;
		$main['tvcmscustomsetting_bestproduct_mainimg_width'] 				= 250;
		$main['tvcmscustomsetting_bestproduct_mainimg_height'] 				= 333;
		$main['tvcmscustomsetting_tvcmsbloggallhome_img_width'] 			= 580;
		$main['tvcmscustomsetting_tvcmsbloggallhome_img_height'] 			= 340;
		...
		$main['tvcmscustomsetting_tvcmsblogfeahome_img_width'] 				= 580;
		$main['tvcmscustomsetting_tvcmsblogfeahome_img_height'] 			= 340;
		...
		$main['tvcmscustomsetting_categoryslider_img_width'] 				= 150;
		$main['tvcmscustomsetting_categoryslider_img_height'] 				= 120;
		...
		$main['tvcmscustomsetting_footerlogo_img_width'] 					= 187;
		$main['tvcmscustomsetting_footerlogo_img_height']					= 49;
		$main['tvcmscustomsetting_footerproduct_width'] 					= 125;
		$main['tvcmscustomsetting_footerproduct_height'] 					= 49;
		...
		$main['tvcmscustomsetting_payment_img_width'] 						= 32;
		$main['tvcmscustomsetting_payment_img_height'] 						= 32;
		$main['tvcmscustomsetting_tvcmsproductgridimg_img_width'] 			= 800;
		$main['tvcmscustomsetting_tvcmsproductgridimg_img_height'] 			= 1067;
		...
		$main['tvcmscustomsetting_special_img_width'] 						= 250;
		$main['tvcmscustomsetting_special_img_height'] 						= 333;
		$main['tvcmscustomsetting_sliderimage_img_width'] 					= 1800;
		$main['tvcmscustomsetting_sliderimage_img_height'] 					= 940;
		$main['tvcmscustomsetting_tvcmssingleblock_img_width'] 				= 720;
		$main['tvcmscustomsetting_tvcmssingleblock_img_height'] 			= 630;
		$main['tvcmscustomsetting_tabproduct_mainimg_width'] 				= 200;
		$main['tvcmscustomsetting_tabproduct_mainimg_height'] 				= 200;
		$main['tvcmscustomsetting_tabproduct_img_width'] 					= 250;
		$main['tvcmscustomsetting_tabproduct_img_height'] 					= 333;
		$main['tvcmscustomsetting_testimonial_mainimg_width'] 				= 200;
		$main['tvcmscustomsetting_testimonial_mainimg_height'] 				= 200;
		$main['tvcmscustomsetting_testimonial_img_width'] 					= 60;
		$main['tvcmscustomsetting_testimonial_img_height'] 					= 60;
        ...
        foreach ($languages as $value) {
        	...
        	$main['tvcmscustomsetting_customsub']['lang_text'][$value['language_id']] =  array('text'=>"© 2018 - Ecommerce software by Opencart™",'link'=>"#",'nopro'=>"10",'newslettertitle'=>"newsletter","newslettersubtitle"=>"Subscribe to our email newsletter today to receive update on the latest news");
		}
	...
	public function makeInslineStyleSheet(){
        ...
        if ($themeoptions == 'theme_custom') {
            ...
            $ftpThemeDir = DIR_CATALOG."view/theme/themevolty_fashion_101/assets/css";
